...
import { createRoom } from "@briom/app/_bak/api/rooms/actions";
...
import type { AvailableModelDTO } from "@briom/core/application/_bak";
...
} from "./create-room-form/participant-row";
...
export function RoomProvider({ availableModels, children }: RoomProviderProps) {
	...
	return (
		<RoomContext.Provider value={{ openRoomFormDialog: () => setOpen(true) }}>
