...
export function ParticipantTurnMenu({
	...
	return (
		<div className="flex items-center gap-2 flex-1 text-[11px] text-muted-foreground/50 font-mono tabular-nums lg:opacity-0 group-hover:opacity-100 transition-opacity duration-300">
			{time}
