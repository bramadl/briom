...
import { CheckIcon, CopyIcon, EditIcon, ReplyIcon } from "lucide-react";
import { useState } from "react";
import { useCopyToClipboard } from "usehooks-ts";

interface TurnPerspectiveActionsProps {
	content: string;
	isModerator?: boolean;
	time: string;
}

export function TurnPerspectiveActions({
	content,
	isModerator,
	time,
}: TurnPerspectiveActionsProps) {
